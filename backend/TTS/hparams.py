...
# "transcript.v.1.4.txt" or "transcript.v.1.3.txt"
...
vocoder_pretrained_model_path = os.path.join(base_path + "/vocoder/pretrained_models/", vocoder_pretrained_model_name)
